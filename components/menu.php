<div class="mx-5 my-3">
    <form class="row justify-content-center " action="../views/ativos.php" method="post">
        ...
        <a class="btn btn-outline-primary btn-sm rounded-5 col-sm-1 col-4 m-auto mb-3 mb-sm-0" href="inserir_livro.php">Adicionar</a>
        <div class="btn-group col-sm-2 col-8" role="group" aria-label="Basic mixed styles example">
