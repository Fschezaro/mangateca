...
if (isset($_POST['pesquisa'])) {
    ...
    $query = $conexao->prepare("SELECT * FROM LIVROS WHERE estado = '0' AND (titulo IS NOT NULL AND categoria IS NOT NULL AND autor IS NOT NULL AND editora IS NOT NULL) AND (titulo LIKE '%$pesquisa%' OR categoria LIKE '%$pesquisa%' OR autor LIKE '%$pesquisa%' OR editora LIKE '%$pesquisa%' OR tipo LIKE '%$pesquisa% OR tipo LIKE '%$pesquisa%'')");
} else {
    $query = $conexao->prepare("SELECT * FROM LIVROS WHERE estado = '0' AND (titulo IS NOT NULL AND categoria IS NOT NULL AND autor IS NOT NULL AND editora IS NOT NULL)");
}
$query->execute();
